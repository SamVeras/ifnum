/*!
 * @file Matriz.tpp
 * @brief Implementação dos métodos da classe template Matriz.
 *
 * Este arquivo contém a implementação das funcionalidades declaradas em `Matriz.hpp`.
 */
 ...
 * deixando-os com valor padrão de T.
 *
 * @tparam T Tipo dos elementos da matriz.
 * @param linhas Número de linhas da matriz.
 * @param colunas Número de colunas da matriz.
...
Matriz<T>::Matriz(size_t linhas, size_t colunas)
    : linhas_(linhas), colunas_(colunas), matriz_(linhas * colunas, 0)
{
}
